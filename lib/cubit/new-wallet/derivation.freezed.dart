...
mixin _$DeriveWalletState {
  ...
  @JsonKey(ignore: true)
  $DeriveWalletStateCopyWith<DeriveWalletState> get copyWith =>
...
class _$DeriveWalletStateImpl
  ...
  @override
  @JsonKey()
  final DeriveWalletStep currentStep;
  @override
  @JsonKey()
...
abstract class _DeriveWalletState implements DeriveWalletState {
  const factory _DeriveWalletState(
      {final DeriveWalletStep currentStep,
      final DerivationPurpose purpose,
      final int index,
      final String rawPath,
