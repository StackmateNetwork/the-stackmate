...
class _$_HistoryState extends _HistoryState with DiagnosticableTreeMixin {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'HistoryState(loadingTransactions: $loadingTransactions, errLoadingTransactions: $errLoadingTransactions, loadingBalance: $loadingBalance, errLoadingBalance: $errLoadingBalance, balance: $balance, transactions: $transactions, errDeleting: $errDeleting, deleted: $deleted, showInfo: $showInfo)';
  }
